 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    | Q/L1 |   W  |   ,  |   .  |   ;  |  '   |           |   \  |   M  |   R  |   D  |   Y  | P/L1 |  DEL   |
 * |--------+------+------+------+------+------|  Cmd |           |  Cmd |------+------+------+------+------+--------|
 * |WordCAPS|   A  |   O  |   E  |   I  |   U  |------|           |------|   G  |   T  |   K  |   S  |  N   |APP/Alt |
 * |--------+------+------+------+------+------|   =  |           |   -  |------+------+------+------+------+--------|
 * | LShift(|Z/Ctrl| X/ALT|   C  |   V  |   F  |      |           |      |   B  |   H  |   J  | L/ALT|//Ctrl| RShift)|
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
...
[BASE] = LAYOUT_ergodox(
  ...
  KC_TAB,          LT(SYMB,KC_Q),KC_W,      KC_COMM, KC_DOT,  KC_SCLN, GUI_T(KC_QUOT),
  CW_TOGG,         KC_A,        KC_O,       KC_E,    KC_I,    KC_U,
  SC_LSPO,         CTL_T(KC_Z), LALT_T(KC_X),KC_C,   KC_V,    KC_F,    KC_EQL,
  ...
  GUI_T(KC_BSLS),KC_M,   KC_R,    KC_D,    KC_Y,              LT(SYMB,KC_P),      KC_DEL,
  KC_G,         KC_T,    KC_K,    KC_S,    KC_N,              LALT_T(KC_APP),
  KC_MINS,      KC_B,    KC_H,    KC_J,    LALT_T(KC_L),      CTL_T(KC_SLSH),     SC_RSPC,
